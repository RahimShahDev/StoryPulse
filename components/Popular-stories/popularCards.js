...
function Contents() {
    ...
    const fetchStories = async (page = 1) => {
        try {
            const response = await axiosInstance.get(`/get-stories?page=${page}&story=popular`);
    ...
    return (
        <div>
            <div className="first-row flex justify-between items-center p-4 md:p-8">
                <h3 className="text-xl py-2 font-bold border-b-4 border-orange-400">Popular Stories</h3>
            </div>
